...
//             $html .= '<p><strong>Lab Picture:</strong> <img src="uploads/' . $school['lab_picture'] . '" alt="Lab Picture" style="max-width: 300px;"></p>';
//         }
//         if (!empty($school['environment_picture'])) {
//             $html .= '<p><strong>Environment Picture:</strong> <img src="uploads/' . $school['environment_picture'] . '" alt="Environment Picture" style="max-width: 300px;"></p>';
//         }
//         if (!empty($school['school_picture'])) {
//             $html .= '<p><strong>School Picture:</strong> <img src="uploads/' . $school['school_picture'] . '" alt="School Picture" style="max-width: 300px;"></p>';
//         }
...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (!empty($school['lab_picture'])) {
            $html .= '<p><strong>Lab Picture:</strong> <img src="http://localhost/Itkcproj/uploads/' . $school['lab_picture'] . '" alt="Lab Picture" style="max-width: 300px;"></p>';
        }
        if (!empty($school['environment_picture'])) {
            $html .= '<p><strong>Environment Picture:</strong> <img src="http://localhost/Itkcproj/uploads/' . $school['environment_picture'] . '" alt="Environment Picture" style="max-width: 300px;"></p>';
        }
        if (!empty($school['school_picture'])) {
            $html .= '<p><strong>School Picture:</strong> <img src="http://localhost/Itkcproj/uploads/' . $school['school_picture'] . '" alt="School Picture" style="max-width: 300px;"></p>';
        }
